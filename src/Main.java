...
public class Main {
    ...
    public static final String GOOD_NIGHT     = "GN";
    ...
    private static void goodNight(Scanner in , ContactBook cBook){
            int numb;
            numb = in.nextInt();
            in.nextLine();
            if(cBook.hasNumb(numb)){
                System.out.println(cBook.getContact(numb));
            }
